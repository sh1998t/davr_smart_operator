...
class ApkColor{
  ...
  static Color dropDownColor =Color(0xFFEEF2F4);
  static Color deleteButtonBorderColor =Color(0xFFF92E0A);
  static Color deleteBackgroundColor =Color(0xFFFDD5CE);
  static Color labelColor =Color(0xFF6A707C);
